...
<%
    ...
    Mysql.getConnection();
    HashMap<String,User> map=Mysql.selectUser();
        ...
        <div class="col-md-8 banner-right">
            <div class="sap_tabs">
                <div class="booking-info">
                    <% if (userid != null && password != null&& map.get(userid) != null){%>
                    <% String realpassword = (String)map.get(userid).getPasswd();%>
                    <%if(realpassword != null && realpassword.equals(password)) {%>
                    <% session.setAttribute("username",userid);%>
                    <h2>Login success! Welcome <%= session.getAttribute("username")%></h2>
                    <form action="index.jsp">
                        <input type="submit" value="Home">
                    </form>
                    <% } else { %>
                    <h2>Login Failure! Username or password is incorrect!</h2>
                    <% } %>
                    <% } %>
                </div>
            </div>
