            ...
            <div class="sap_tabs">
                <div class="booking-info">
                    ...
                    <% } else { %>
                        ...
                        <h2>Checkout form</h2>
                        <h4>Enter your information  and click Check out</h4>
                        <form method="get" action="/Placeorder.jsp">
                            <table cellpadding='2' cellspacing='1'>
                                <tr>
                                    <td>User ID:</td>
                                    <td><%=session.getAttribute("username")%></td>
                                    <td><input type="hidden" size="15" name="uid" value="<%=session.getAttribute("username")%>"></td>
                                ...
                                <tr>
                                    <td>Creditcard:</td>
                                    <td><input type="TEXT" size="15" name="cc"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" size="15" name="tid" value="<%=request.getParameter("tid")%>"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" size="15" name="price" value="<%=request.getParameter("price")%>"></td>
                                ...
                                <tr>
                                    <td>Order date:</td>
                                    <td><%=date%></td>
                                    <td><input type="hidden" size="15" name="date" value="<%=date%>"></td>
                                </tr>
